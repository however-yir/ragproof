...
```json
{"id":"q-001","question":"什么是 RAG？","ground_truths":["检索增强生成。","Retrieval-augmented generation."],"relevant_doc_ids":["doc-rag"],"expected_citations":["doc-rag"],"tags":["zh","intro"],"difficulty":"easy","answerable":true}
```
